 ...
 */
package com.livehereandnow.ages.card.util;
...
//BUILD SUCCESSFUL (total time: 3 seconds)
    ...
    public static void do1() {
        ...
        Query q = em.createQuery("select t from Card t ");
        int completeCnt = 0;
...
//            parser.doParse(cards.getContent());
        ...
        System.out.println("\n###################");
        System.out.println("Complete/Different kinds of Cards: " + completeCnt + "/" + list.size());
...
//    em.close();
    ...
    public static void do3() {
        ...
        Card c1 = new Card(1, "亞歷山大大帝", 0, "內政", "領袖", "acting...", "icon..", "cost...", "color", 1);
